...
class App extends React.Component {
  ...
  getBills(repName) {
    $.ajax({
        url: "legislation.nysenate.gov/api/3/bills/2015/search?term=votes.size:>0%20AND%20year:2016&key=042A2V22xkhJDsvE22rtOmKKpznUpl9Y&offset=1&limit=1000&full=true",
        method: "GET"
    })
    .done(function(response) {
      // bills w/ floor votes
